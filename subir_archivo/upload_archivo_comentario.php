...
<?php 
    ...
    $directorio="archivos_subidos/archivos_comentario/".$idComentario."/";
    ...
    if($size>419430400){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'], $archivo)){//move_uploaded_file — Mueve un archivo subido a una nueva ubicación
            ...
            $consulta_insertar_archivo_post ="UPDATE `post` SET `archivo` = '$rutaFinalArchivo' WHERE `id_Post`='$idComentario'";
